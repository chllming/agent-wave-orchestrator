...
- Renamed the versioned operating guide to `docs/guides/recommendations-0.9.2.md` and updated release-surface references, install seeding, and regression coverage to match the new package version exactly.
